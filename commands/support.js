...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const supportServerLink = "https://discord.gg/WDkx46Ux5B";
      const githubLink = "https://github.com/AishiDaBoi";
      const replitLink = "https://replit.com/@IcyAMV";
      const youtubeLink = "https://www.youtube.com/@3ahomos";
        const embed = new EmbedBuilder()
            ...
            .setAuthor({
              ...
              url: 'https://discord.gg/WDkx46Ux5B'
          })
